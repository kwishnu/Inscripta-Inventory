...
private const val TAG = "InscriptaInventory_F17"
    ...
    object SetAdapterFromActivity {
        operator fun invoke(
            ...
            if (reason == "deleteItem") {
                ...
                MainActivity.globalDataArray.add(AddItemActivity.itemIndexInGlobalArray, mutableListOf(imageNum, partNum, itemName, minStockLevel, numInStock, commentStr, "2", "17"))
